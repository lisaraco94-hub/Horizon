...
export const MOCK_LABS = [
  ...
  { id: 4, name: "Guangzhou First People's Hospital", city: "Guangzhou", country: "China", region: "CHINA" as const, lat: 23.13, lng: 113.26, type: "Public Hospital", volume: "1,000 - 3,000", automation: "No automation (manual)", ivd: ["Mindray", "Sysmex"], stage: "mapped" as const, product: ["FlexLab X"], rfp: "Unknown", notes: [], score: 45 },
  ...
  { id: 7, name: "Bucharest Emergency Hospital", city: "Bucharest", country: "Romania", region: "EAST_EU" as const, lat: 44.44, lng: 26.10, type: "Public Hospital", volume: "1,000 - 3,000", automation: "Competitor full system", ivd: ["Abbott", "bioMérieux"], stage: "mapped" as const, product: [], rfp: "Unknown", notes: [], score: 38 },
  ...
  { id: 9, name: "King Faisal Specialist Hospital", city: "Riyadh", country: "Saudi Arabia", region: "APAC" as const, lat: 24.69, lng: 46.72, type: "Private Hospital", volume: "3,000+", automation: "Competitor full system", ivd: ["Roche", "Siemens Healthineers"], stage: "qualified" as const, product: ["FlexLab X"], rfp: "RFP expected", rfpDate: "2026-06", notes: [{ date: "2026-03-02", author: "Director", text: "High-priority target. Current Beckman automation line aging. Hospital expanding diagnostic center. Budget confirmed for Q3-Q4 2026." }], score: 91 },
  { id: 10, name: "Apollo Hospitals Chennai", city: "Chennai", country: "India", region: "APAC" as const, lat: 13.06, lng: 80.24, type: "Hospital Network", volume: "3,000+", automation: "Partial pre-analytical (competitor)", ivd: ["Abbott", "Sysmex", "Roche"], stage: "engaged" as const, product: ["FlexLab X"], rfp: "No RFP expected", notes: [{ date: "2026-01-15", author: "Director", text: "Apollo network is expanding. Chennai hub lab could be a reference installation for the group. Need to build relationship with corporate procurement." }], score: 71 },
  { id: 11, name: "Bangkok Hospital", city: "Bangkok", country: "Thailand", region: "APAC" as const, lat: 13.74, lng: 100.54, type: "Private Hospital", volume: "1,000 - 3,000", automation: "No automation (manual)", ivd: ["Roche"], stage: "mapped" as const, product: [], rfp: "Unknown", notes: [], score: 42 },
