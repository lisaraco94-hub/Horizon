...
export const MOCK_LABS = [
  ...
  { id: 4, name: "Guangzhou First People's Hospital", city: "Guangzhou", country: "China", region: "CHINA" as const, lat: 23.13, lng: 113.26, type: "Public Hospital", volume: "1,000 - 3,000", tubesPerDay: "2,100", automation: "No automation (manual)", ivd: ["Siemens Healthineers"], ivdPartnerInvolved: "Siemens Healthineers", stage: "mapped" as const, product: ["FlexLab X"], rfp: "Unknown", notes: [], score: 45, distributor: "China Medical Systems" },
  ...
  { id: 7, name: "Bucharest Emergency Hospital", city: "Bucharest", country: "Romania", region: "EAST_EU" as const, lat: 44.44, lng: 26.10, type: "Public Hospital", volume: "1,000 - 3,000", tubesPerDay: "1,400", automation: "Competitor full system", ivd: ["Abbott", "IDS"], ivdPartnerInvolved: "Abbott", stage: "mapped" as const, product: [], rfp: "Unknown", notes: [], score: 38, distributor: "RomLab Solutions" },
