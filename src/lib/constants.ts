...
export const MOCK_LABS = [
  ...
  { id: 2, name: "São Paulo Reference Laboratory", city: "São Paulo", country: "Brazil", region: "LATAM" as const, lat: -23.55, lng: -46.63, type: "Reference Lab", volume: "3,000+", automation: "Competitor full system", ivd: ["Roche", "Abbott"], stage: "engaged" as const, product: ["FlexLab X"], rfp: "No RFP expected", notes: [{ date: "2026-02-28", author: "Fabio Cuhna", text: "Initial contact through Roche transition. Current system is aging. Exploring options for 2027-2028 renewal." }], score: 65, distributor: "Blue Health" },
  { id: 3, name: "Beijing Ditan Hospital", city: "Beijing", country: "China", region: "CHINA" as const, lat: 39.95, lng: 116.38, type: "Public Hospital", volume: "3,000+", automation: "Partial pre-analytical (competitor)", ivd: ["Roche"], stage: "qualified" as const, product: ["FlexLab X", "ProTube"], rfp: "RFP published", rfpDate: "2026-04", notes: [{ date: "2026-03-01", author: "Frederick Leung", text: "RFP published March 1st. Deadline April 15. We are positioned well through local distributor. Decision maker met twice." }], score: 94, distributor: "China Medical Systems" },
  { id: 4, name: "Guangzhou First People's Hospital", city: "Guangzhou", country: "China", region: "CHINA" as const, lat: 23.13, lng: 113.26, type: "Public Hospital", volume: "1,000 - 3,000", automation: "No automation (manual)", ivd: ["Siemens Healthineers"], stage: "mapped" as const, product: ["FlexLab X"], rfp: "Unknown", notes: [], score: 45, distributor: "China Medical Systems" },
  ...
  { id: 6, name: "Warsaw Central Hospital", city: "Warsaw", country: "Poland", region: "EAST_EU" as const, lat: 52.23, lng: 21.01, type: "Public Hospital", volume: "500 - 1,000", automation: "No automation (manual)", ivd: ["Roche", "IDS"], stage: "engaged" as const, product: ["FlexLab X"], rfp: "No RFP expected", notes: [{ date: "2026-02-20", author: "Riccardo Melis", text: "Met at IFCC Europe. Interested but no budget allocated yet. Government funding cycle is annual - need to wait for 2027 allocation." }], score: 52, distributor: "MedPol Distribution" },
  { id: 7, name: "Bucharest Emergency Hospital", city: "Bucharest", country: "Romania", region: "EAST_EU" as const, lat: 44.44, lng: 26.10, type: "Public Hospital", volume: "1,000 - 3,000", automation: "Competitor full system", ivd: ["Abbott", "IDS"], stage: "mapped" as const, product: [], rfp: "Unknown", notes: [], score: 38, distributor: "RomLab Solutions" },
  { id: 8, name: "Prague University Hospital", city: "Prague", country: "Czech Republic", region: "EAST_EU" as const, lat: 50.08, lng: 14.42, type: "University Hospital", volume: "1,000 - 3,000", automation: "Partial pre-analytical (competitor)", ivd: ["Beckman Coulter", "Roche"], stage: "exploring" as const, product: ["FlexLab X", "ProTube"], rfp: "RFP expected", rfpDate: "2026-07", notes: [{ date: "2026-02-25", author: "Riccardo Melis", text: "Strong opportunity. Lab is consolidating from 3 buildings into 1. Need full automation. RFP expected July." }], score: 79, distributor: "CzechMed" },
  { id: 9, name: "King Faisal Specialist Hospital", city: "Riyadh", country: "Saudi Arabia", region: "APAC" as const, lat: 24.69, lng: 46.72, type: "Private Hospital", volume: "3,000+", automation: "Competitor full system", ivd: ["Roche", "Siemens Healthineers"], stage: "qualified" as const, product: ["FlexLab X"], rfp: "RFP expected", rfpDate: "2026-06", notes: [{ date: "2026-03-02", author: "Director (TBD)", text: "High-priority target. Current Beckman automation line aging. Hospital expanding diagnostic center. Budget confirmed for Q3-Q4 2026." }], score: 91, distributor: "Gulf Medical Trading" },
  { id: 10, name: "Apollo Hospitals Chennai", city: "Chennai", country: "India", region: "APAC" as const, lat: 13.06, lng: 80.24, type: "Hospital Network", volume: "3,000+", automation: "Partial pre-analytical (competitor)", ivd: ["Abbott", "Roche"], stage: "engaged" as const, product: ["FlexLab X"], rfp: "No RFP expected", notes: [{ date: "2026-01-15", author: "Director (TBD)", text: "Apollo network is expanding. Chennai hub lab could be a reference installation for the group. Need to build relationship with corporate procurement." }], score: 71, distributor: "MedTech India" },
